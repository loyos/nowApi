...
var AddPromoComponent = /** @class */ (function () {
    function AddPromoComponent(madridService, toastr, vcr) {
        ...
        this.toastr = toastr;
        this.checked = [];
        this.a = ['lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo'];
        this.promo = {
            name: '',
            info: '',
            day: '',
    ...
    AddPromoComponent.prototype.addPromo = function () {
        ...
        console.log(files);
        this.checked.forEach(function (data, i) {
            if (_this.checked[i]) {
                _this.promo.day = _this.a[i] + ',' + _this.promo.day;
            }
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__angular_material_checkbox__ = __webpack_require__("./node_modules/@angular/material/esm5/checkbox.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_23__angular_material_checkbox__["a" /* MatCheckboxModule */]
            ],
...
var EditPromoComponent = /** @class */ (function () {
    ...
    EditPromoComponent.prototype.getPromo = function (id) {
        ...
        this.madridService.getPromo(this.id).subscribe(function (data) {
            ...
            _this.setDays(_this.promo.day.split(','));
        });
    };
    EditPromoComponent.prototype.setDays = function (days) {
        var _this = this;
        console.debug("days: ", days);
        days.forEach(function (el, i) {
            _this.a.forEach(function (e, j) {
                if (el == e) {
                    _this.checked[j] = true;
                }
                else {
                    _this.checked[j] = _this.checked[j] == true ? true : false;
                }
            });
        });
